...
@section('title', $Edit->title.' | Video Kategori Düzenle')
@section('content')
    {{Form::model($Edit, ["route" => ["video-categories.update", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
        <div class="col-12 col-md-9">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="d-flex">
                        <h4 class="card-title justify-content-center align-items-center">
                            ...
                            Kategori Düzenle [ {{$Edit->title }}]
                        </h4>
                    </div>
                    <div>
                        <a class="btn btn-tabler btn-sm" href="{{  url()->previous() }}" title="Geri">
                        ...
                        <button class="btn btn-tabler btn-sm">
                ...
                <div class="card-body">
                    ...
                    <x-form-inputtext label="Seo Başlık" name="seo_title"></x-form-inputtext>
                    <x-form-inputtext label="Video Açıklama" name="seo_desc"></x-form-inputtext>
                    <x-form-inputtext label="Video Anahtar Kelime " name="seo_key"></x-form-inputtext>
                </div>
            </div>
        </div>
...
@section('customJS')
    ...
    <script type="text/javascript">
        ...
        CKEDITOR.replace( 'aciklama', {
            filebrowserUploadUrl: "{{ route('video-categories.postUpload', ['_token' => csrf_token()]) }}",

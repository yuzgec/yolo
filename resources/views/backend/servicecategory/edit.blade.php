...
@section('title', $Edit->title.' | Hizmet Kategori Düzenle')
@section('content')
    {{Form::model($Edit, ["route" => ["service-categories.update", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
...
@section('customJS')
    ...
    <script type="text/javascript">
        ...
        CKEDITOR.replace( 'aciklama', {
            filebrowserUploadUrl: "{{ route('service-categories.postUpload', ['_token' => csrf_token()]) }}",

...
<section id="team" class="pb-120 mt-50">
    ...
    <div class="container mt-55 t-left">
        ...
        <div class="row">
            <div class="col-lg-4 col-sm-6 col-12 mt-30 c-plus" data-bs-toggle="modal" data-bs-target="#modal-01">
                <div class="row row-eq-height">
                    ...
                    <div class="col height-400 mr-15 dark-bottom d-flex align-items-end justify-content-start flex-wrap" data-bg="url(https://cdn.cloudflare.steamstatic.com/steamcommunity/public/images/avatars/a1/a15e3308ee7183d1b6cb5a3f61eca2846394fb43_full.jpg)">
                        <div class="t-center fullwidth p-3">
                            <h4 class="fs-13 white uppercase ls-3">Mehmet Yılmaz</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12 mt-120 t-center">
                <h5 class="font-secondary uppercase fs-20 fs-14-sm black"><a href="#" class="career-btn underline-slide underline-hover-slide">Ekibimize Katılmak İster Misin?</a></h5>
            </div>
    ...
    <!-- Modal -->
    <div id="modal-01" class="modal fade fade-scale" tabindex="-1" role="dialog">

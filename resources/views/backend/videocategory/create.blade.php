...
@section('title', 'Video Kategori Ekle')
@section('content')
    <div class="col-12 col-md-9">
        <div class="card">
            {{Form::open(['route' => 'video-categories.store', 'enctype' => 'multipart/form-data'])}}
            <div class="card-header d-flex justify-content-between">
                <x-add title="Video Kategori"></x-add>
                <div>
                    <x-back></x-back>
                    <x-save></x-save>
                </div>
             ...
             <div class="card-body">
                  ...
                  <x-form-inputtext label="Video Açıklama" name="seo_desc"/>
                  <x-form-inputtext label="Video Anahtar Kelime " name="seo_key"/>
            </div>
        </div>
    </div>

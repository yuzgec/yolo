...
@section('title', 'Ekip Ekle')
@section('content')
    <div class="col-12 col-md-9">
        <div class="card">
            {{Form::open(['route' => 'team.store', 'enctype' => 'multipart/form-data'])}}

                <div class="card-header d-flex justify-content-between">
                    <x-add title="Ekip"></x-add>
                    <div>
                        <x-back></x-back>
                        <x-save></x-save>
                    </div>
                ...
                <div class="card-body">
                <x-form-inputtext label="Ad Soyad" name="title"/>
                ...
                <x-form-inputtext label="Görevi" name="master"/>
                <x-form-inputtext label="İnstagram" name="instagram"/>
                <x-form-inputtext label="Youtube" name="youtube"/>
...
@section('customJS')
    ...
    <script type="text/javascript">
        ...
        CKEDITOR.replace( 'aciklama', {
            filebrowserUploadUrl: "{{ route('team.postUpload', ['_token' => csrf_token()]) }}",

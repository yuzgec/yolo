...
@section('content')
<section id="home" class="relative white bg-soft-dark7 height-60vh mnh-250 align-items-center d-flex" 
    ...
    <div class="container-md mt-100">
        <div class="t-center">
            ...
            <div
                ...
                <i class="ti-angle-right fs-7 mx-15"></i>
                <a href="{{ route('studios')}}" title="Stüdyolarımız"  class="c-default">Stüdyolarımız</a>
                <i class="ti-angle-right fs-7 mx-15"></i>
        ...
        <div class="row">
            <div class="col-md-8 col-12 pt-50">
                <div class="fs-16 fs-16-sm gray7 ls-0 lh-35 light">
                    <div>
                        <img src="{{ (!$Detay->getFirstMediaUrl('page')) ? '/front/resimyok.jpg' : $Detay->getFirstMediaUrl('page')}}" alt="Karşıyaka {{ $Detay->title}} - Karşıyaka Yolo Studio" class="img-fluid mb-30">
                    </div>

...
@section('title', $Edit->title.' | Galeri Düzenle')
@section('content')
    {{Form::model($Edit, ["route" => ["gallery.update", $Edit->id],'enctype' => 'multipart/form-data'])}}
    @method('PUT')
    <div class="row">
...
@section('customJS')
    ...
    <script type="text/javascript">
        ...
        CKEDITOR.replace( 'aciklama', {
            filebrowserUploadUrl: "{{ route('gallery.postUpload', ['_token' => csrf_token()]) }}",
